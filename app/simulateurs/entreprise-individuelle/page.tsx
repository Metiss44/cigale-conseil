...
export default function SimulateurAutoEntrepreneur() {
    ...
    useEffect(() => {
        ...
        script.setAttribute('data-module', 'simulateur-autoentrepreneur');
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="mb-8 bg-white/60 backdrop-blur-sm rounded-xl p-6 border border-brand-sage-light/30">
                            ...
                            <p className="text-brand-sage-gray mb-3">
                                Ce simulateur officiel de l'URSSAF vous permet d'estimer vos charges sociales en fonction de votre chiffre d'affaires.
                            </p>
                            <p className="text-brand-sage-gray">
                                Pour un accompagnement personnalisé dans la gestion de votre activité, n'hésitez pas à{' '}
