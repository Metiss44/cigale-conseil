                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="text-center mb-8">
                            ...
                            <p className="text-lg md:text-xl text-brand-sage-gray max-w-3xl mx-auto">
                                Estimez vos cotisations sociales et votre revenu net en tant que président de SASU (assimilé salarié).
                        ...
                        <div className="mb-8 bg-white/60 backdrop-blur-sm rounded-xl p-6 border border-brand-sage-light/30">
                            ...
                            <p className="text-brand-sage-gray mb-3">
                                Ce simulateur officiel de l'URSSAF vous permet d'estimer vos charges sociales en tant que président de SASU (Société par Actions Simplifiée Unipersonnelle) au régime assimilé salarié.
                            </p>
