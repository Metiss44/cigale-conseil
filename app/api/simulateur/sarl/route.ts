  ...
  try {
    ...
    const payload = {
      ...
      expressions: [
        ...
        "dirigeant . indépendant . revenu net",
        "dirigeant . indépendant . revenu net après impôt"
      ]
    };
    ...
    if (!res.ok) {
      ...
      console.error('Erreur URSSAF SARL:', text);
      return NextResponse.json(
    ...
    const resultat: ResultatSimulationSARL = {
    ...
    console.error('Erreur interne SARL:', e);
    return NextResponse.json(
